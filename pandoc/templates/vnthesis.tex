...
\definecolor{deepgreen}{RGB}{0, 112, 0}
...
\lstset{
    ...
    postbreak=\mbox{\textcolor{deepblue}{$$\hookrightarrow$$}\space},
    frame=shadowbox,
    rulesepcolor=\color{bubblegum},
    rulecolor=\color{cyclamen},
    tabsize=2,
    texcl=true,
}
...
$for(customheader)$$customheader$$endfor$
